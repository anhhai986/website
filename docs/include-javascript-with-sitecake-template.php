    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-9 offset-md-3 sc-content">
                <h1>Using Javascript In Templates</h1>
                
            </div>
            <div class="col-xs-12 col-md-9 push-md-3 sc-content">
                <h2>Summary</h2>
                <ul>
                   <li>Detect edit mode with sitecakeGlobals.editMode boolean and turn your script off</li>
                </ul>
                
                <h2>Example</h2>
                
                <p>It happens that some specific javascript you want to use can make problems in Sitecake editing mode. In that case solution is to exclude that script in edit mode. There is a boolean sitecakeGlobals.editMode that you can use for edit mode detection. </p>
                <p>So if you want to turn off some js,  put similar script in the header of your page:</p>
            ...
            <div class="sidebar col-xs-12 col-md-3 pull-md-9 sc-content-sidebar">
                <ul class="list-unstyled">
                    ...
                    <li><a class="active" href="include-javascript-with-sitecake-template.php">Using Javascript in templates</a></li>                    
