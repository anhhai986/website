    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-9 push-md-3 sc-content">
                ...
                <p>Sitecke does not use any specific template language/script for website page templates. It uses plain HTML markup for that purpose. More details about templates could be found <a target="_blank" href="https://github.com/sitecake/sitecake/wiki/Sitecake-Templates">here</a>.</p>
