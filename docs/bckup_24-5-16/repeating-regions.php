...
<meta name="keywords"  content="repeating regions, sitecake, footer" />
<meta name="description" content=">How to create repeating regions in SiteCake" />
<meta name="allow-search" content="yes" />
<meta name="robots" content="all, index, follow" />
<meta name="copyright" content="SiteCake" />
<title>How to create repeating regions in SiteCake</title>
...
<!-- #EndLibraryItem --></div>
<div class="article sc-content-repeatingregions"><h1 class="">Creating repeating regions<br></h1><h2 class="">Summary<br></h2><ul class="inshort"><li>use same class=’sc-content-[id]’ on different DIVs<br></li></ul><h2 class="">Repeating regions<br></h2><p class="">Repeating same content throughout the site with SiteCake is really easy. All you need to do is when designing the template to assign same class name for all editable containers that should have identical content. <br></p><p class="">This is particularly useful for footers, just apply class=’sc-content-footer’ on all footer DIVs throughout the site and they will always have the same content. Once you edit the content on one page, all other pages will be update automatically. <br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class=""><br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class="">&nbsp;<br></p><p class=""><br></p></div>
	</div>
	<!--container--> 
</div>
<!--wrapper-->
