    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-9 push-md-3 sc-content">
                ...
                <p>At the moment the following languages are supported:</p>
                ...
                <p>The interface language is specified setting the <strong>LocaleProxyImpl.interfaceLocale</strong> configuration paramter (in the editor.cfg file).</p>
                
                <p class="code">
                   # interface language (en, sl, sr, es, de, fr, dk, it, ru, cs, sk, pt, pt-br, nl, tr, nn, auto)<br>
                   LocaleProxyImpl.interfaceLocale = en</p>
                   
                <p>It can be set to either the 2-letter language code (ISO 639-2 Language Codes) of a supported language or to the ‘auto’ option.</p>
                <p>In case the auto option is set, the interface language is selected either by the GET parameter scln, if it is presented, or by the browser (or system) language settings.</p>
                <p>The following is an example of URL for accessing a Sitecake-enabled page selecting English as the interface language by the scln paramter, where the LocaleProxyImpl.interfaceLocale is set to ‘auto’’:</p>
                <p class="code">http://example.com/about.html?scln=en</p>
            ...
            <div class="sidebar col-xs-12 col-md-3 pull-md-9 sc-content-sidebar">
                <ul class="list-unstyled">
                    ...
                    <li><a class="active" href="how-to-change-sitecake-ui-language.php">Changing Sitecake UI language</a></li>
                </ul>
            </div>
