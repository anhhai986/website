    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-9 push-md-3 sc-content">
                <h2>Summary</h2>
                <ul>
                   <li>use same class=’sc-content-[id]’ on different DIVs</li>
                </ul>
                <h2>Repeating regions</h2>
                <p>Repeating same content throughout the site with Sitecake is really easy. All you need to do is when designing the template to assign same class name for all editable containers that should have identical content.</p>
                <p>This is particularly useful for footers, just apply class=’sc-content-footer’ on all footer DIVs throughout the site and they will always have the same content. Once you edit the content on one page, all other pages will be update automatically.</p>
            ...
            <div class="sidebar col-xs-12 col-md-3 pull-md-9 m-t-3 sc-content-sidebar">
                <ul class="list-unstyled">
                   ...
                   <li><a href="install.php">Getting started</a></li>
                    ...
                    <li><a class="active" href="repeating-regions.php">Creating repeating regions</a></li>
